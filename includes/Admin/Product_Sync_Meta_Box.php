...
class Product_Sync_Meta_Box
{
	...
	public static function output()
	{
		...
		if ($fb_product_id) {
			...
			<a href="https://facebook.com/<?php echo esc_attr($fb_product_id); ?>"
			   target="_blank"><?php echo esc_html($fb_product_id); ?></a>
				...
				if ($product_item_ids_by_variation_id) :
					...
					<p>
						...
						foreach ($product_item_ids_by_variation_id as $variation_id => $product_item_id) :
							...
							<?php if ($show_link) : ?>
							<a href="https://facebook.com/<?php echo esc_attr($product_item_id); ?>"
							   target="_blank"><?php echo esc_html($product_item_id); ?></a>
						<?php else : ?>
