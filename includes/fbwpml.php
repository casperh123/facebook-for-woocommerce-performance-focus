					...
					<div class="wpml-section-content-inner">
						<form id="icl_fb_woo" name="icl_fb_woo" action="">
							...
							<?php foreach ($settings as $language => $set) : ?>
								...
								<p>
									<label>
										<input type="checkbox" id="icl_fb_woo_chk"
											   name="<?php echo esc_attr($language); ?>" <?php checked($set, FB_WPML_Language_Status::VISIBLE); ?>>
							...
							<p class="icl_ajx_response_fb" id="icl_ajx_response_fb"
							   hidden="true"><?php esc_html_e("Saved. An automated sync from Facebook will run every hour to update the catalog with any changes you've made.", 'facebook-for-woocommerce'); ?></p>
